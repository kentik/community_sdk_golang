...
// GetLatencyCriticalStddev returns the LatencyCriticalStddev field value if set, zero value otherwise.
func (o *V202101beta1HealthSettings) GetLatencyCriticalStddev() float32 {
	if o == nil || o.LatencyCriticalStddev == nil {
		var ret float32
		return ret
	}
	return *o.LatencyCriticalStddev
}

// GetLatencyCriticalStddevOk returns a tuple with the LatencyCriticalStddev field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V202101beta1HealthSettings) GetLatencyCriticalStddevOk() (*float32, bool) {
	if o == nil || o.LatencyCriticalStddev == nil {
		return nil, false
	}
	return o.LatencyCriticalStddev, true
}

// HasLatencyCriticalStddev returns a boolean if a field has been set.
func (o *V202101beta1HealthSettings) HasLatencyCriticalStddev() bool {
	if o != nil && o.LatencyCriticalStddev != nil {
		return true
	}
...
// SetLatencyCriticalStddev gets a reference to the given float32 and assigns it to the LatencyCriticalStddev field.
func (o *V202101beta1HealthSettings) SetLatencyCriticalStddev(v float32) {
	o.LatencyCriticalStddev = &v
}

// GetLatencyWarningStddev returns the LatencyWarningStddev field value if set, zero value otherwise.
func (o *V202101beta1HealthSettings) GetLatencyWarningStddev() float32 {
	if o == nil || o.LatencyWarningStddev == nil {
		var ret float32
		return ret
	}
	return *o.LatencyWarningStddev
}

// GetLatencyWarningStddevOk returns a tuple with the LatencyWarningStddev field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V202101beta1HealthSettings) GetLatencyWarningStddevOk() (*float32, bool) {
	if o == nil || o.LatencyWarningStddev == nil {
		return nil, false
	}
	return o.LatencyWarningStddev, true
}

// HasLatencyWarningStddev returns a boolean if a field has been set.
func (o *V202101beta1HealthSettings) HasLatencyWarningStddev() bool {
	if o != nil && o.LatencyWarningStddev != nil {
		return true
	}
...
// SetLatencyWarningStddev gets a reference to the given float32 and assigns it to the LatencyWarningStddev field.
func (o *V202101beta1HealthSettings) SetLatencyWarningStddev(v float32) {
	o.LatencyWarningStddev = &v
}

// GetJitterCriticalStddev returns the JitterCriticalStddev field value if set, zero value otherwise.
func (o *V202101beta1HealthSettings) GetJitterCriticalStddev() float32 {
	if o == nil || o.JitterCriticalStddev == nil {
		var ret float32
		return ret
	}
	return *o.JitterCriticalStddev
}

// GetJitterCriticalStddevOk returns a tuple with the JitterCriticalStddev field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V202101beta1HealthSettings) GetJitterCriticalStddevOk() (*float32, bool) {
	if o == nil || o.JitterCriticalStddev == nil {
		return nil, false
	}
	return o.JitterCriticalStddev, true
}

// HasJitterCriticalStddev returns a boolean if a field has been set.
func (o *V202101beta1HealthSettings) HasJitterCriticalStddev() bool {
	if o != nil && o.JitterCriticalStddev != nil {
		return true
	}
...
// SetJitterCriticalStddev gets a reference to the given float32 and assigns it to the JitterCriticalStddev field.
func (o *V202101beta1HealthSettings) SetJitterCriticalStddev(v float32) {
	o.JitterCriticalStddev = &v
}

// GetJitterWarningStddev returns the JitterWarningStddev field value if set, zero value otherwise.
func (o *V202101beta1HealthSettings) GetJitterWarningStddev() float32 {
	if o == nil || o.JitterWarningStddev == nil {
		var ret float32
		return ret
	}
	return *o.JitterWarningStddev
}

// GetJitterWarningStddevOk returns a tuple with the JitterWarningStddev field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V202101beta1HealthSettings) GetJitterWarningStddevOk() (*float32, bool) {
	if o == nil || o.JitterWarningStddev == nil {
		return nil, false
	}
	return o.JitterWarningStddev, true
}

// HasJitterWarningStddev returns a boolean if a field has been set.
func (o *V202101beta1HealthSettings) HasJitterWarningStddev() bool {
	if o != nil && o.JitterWarningStddev != nil {
		return true
	}
...
// SetJitterWarningStddev gets a reference to the given float32 and assigns it to the JitterWarningStddev field.
func (o *V202101beta1HealthSettings) SetJitterWarningStddev(v float32) {
	o.JitterWarningStddev = &v
}

// GetHttpLatencyCriticalStddev returns the HttpLatencyCriticalStddev field value if set, zero value otherwise.
func (o *V202101beta1HealthSettings) GetHttpLatencyCriticalStddev() float32 {
	if o == nil || o.HttpLatencyCriticalStddev == nil {
		var ret float32
		return ret
	}
	return *o.HttpLatencyCriticalStddev
}

// GetHttpLatencyCriticalStddevOk returns a tuple with the HttpLatencyCriticalStddev field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V202101beta1HealthSettings) GetHttpLatencyCriticalStddevOk() (*float32, bool) {
	if o == nil || o.HttpLatencyCriticalStddev == nil {
		return nil, false
	}
	return o.HttpLatencyCriticalStddev, true
}

// HasHttpLatencyCriticalStddev returns a boolean if a field has been set.
func (o *V202101beta1HealthSettings) HasHttpLatencyCriticalStddev() bool {
	if o != nil && o.HttpLatencyCriticalStddev != nil {
		return true
	}
...
// SetHttpLatencyCriticalStddev gets a reference to the given float32 and assigns it to the HttpLatencyCriticalStddev field.
func (o *V202101beta1HealthSettings) SetHttpLatencyCriticalStddev(v float32) {
	o.HttpLatencyCriticalStddev = &v
}

// GetHttpLatencyWarningStddev returns the HttpLatencyWarningStddev field value if set, zero value otherwise.
func (o *V202101beta1HealthSettings) GetHttpLatencyWarningStddev() float32 {
	if o == nil || o.HttpLatencyWarningStddev == nil {
		var ret float32
		return ret
	}
	return *o.HttpLatencyWarningStddev
}

// GetHttpLatencyWarningStddevOk returns a tuple with the HttpLatencyWarningStddev field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V202101beta1HealthSettings) GetHttpLatencyWarningStddevOk() (*float32, bool) {
	if o == nil || o.HttpLatencyWarningStddev == nil {
		return nil, false
	}
	return o.HttpLatencyWarningStddev, true
}

// HasHttpLatencyWarningStddev returns a boolean if a field has been set.
func (o *V202101beta1HealthSettings) HasHttpLatencyWarningStddev() bool {
	if o != nil && o.HttpLatencyWarningStddev != nil {
		return true
	}
...
// SetHttpLatencyWarningStddev gets a reference to the given float32 and assigns it to the HttpLatencyWarningStddev field.
func (o *V202101beta1HealthSettings) SetHttpLatencyWarningStddev(v float32) {
	o.HttpLatencyWarningStddev = &v
}
...
func (o V202101beta1HealthSettings) MarshalJSON() ([]byte, error) {
	...
	if o.LatencyCriticalStddev != nil {
		toSerialize["latencyCriticalStddev"] = o.LatencyCriticalStddev
	}
	if o.LatencyWarningStddev != nil {
		toSerialize["latencyWarningStddev"] = o.LatencyWarningStddev
	}
	if o.JitterCriticalStddev != nil {
		toSerialize["jitterCriticalStddev"] = o.JitterCriticalStddev
	}
	if o.JitterWarningStddev != nil {
		toSerialize["jitterWarningStddev"] = o.JitterWarningStddev
	}
	if o.HttpLatencyCriticalStddev != nil {
		toSerialize["httpLatencyCriticalStddev"] = o.HttpLatencyCriticalStddev
	}
	if o.HttpLatencyWarningStddev != nil {
		toSerialize["httpLatencyWarningStddev"] = o.HttpLatencyWarningStddev
	}
