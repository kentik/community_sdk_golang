...
type V202101beta1TestSettings struct {
	...
	DnsGrid            *V202101beta1DnsGridTest            `json:"dnsGrid,omitempty"`
	ApplicationMesh    *map[string]interface{}             `json:"applicationMesh,omitempty"`
...
func (o *V202101beta1TestSettings) GetDnsGrid() V202101beta1DnsGridTest {
	if o == nil || o.DnsGrid == nil {
		var ret V202101beta1DnsGridTest
		return ret
	}
	return *o.DnsGrid
}
...
// and a boolean to check if the value has been set.
func (o *V202101beta1TestSettings) GetDnsGridOk() (*V202101beta1DnsGridTest, bool) {
	if o == nil || o.DnsGrid == nil {
		return nil, false
	}
...
// SetDnsGrid gets a reference to the given V202101beta1DnsGridTest and assigns it to the DnsGrid field.
func (o *V202101beta1TestSettings) SetDnsGrid(v V202101beta1DnsGridTest) {
	o.DnsGrid = &v
}

// GetApplicationMesh returns the ApplicationMesh field value if set, zero value otherwise.
func (o *V202101beta1TestSettings) GetApplicationMesh() map[string]interface{} {
	if o == nil || o.ApplicationMesh == nil {
		var ret map[string]interface{}
		return ret
	}
	return *o.ApplicationMesh
}

// GetApplicationMeshOk returns a tuple with the ApplicationMesh field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V202101beta1TestSettings) GetApplicationMeshOk() (*map[string]interface{}, bool) {
	if o == nil || o.ApplicationMesh == nil {
		return nil, false
	}
	return o.ApplicationMesh, true
}

// HasApplicationMesh returns a boolean if a field has been set.
func (o *V202101beta1TestSettings) HasApplicationMesh() bool {
	if o != nil && o.ApplicationMesh != nil {
		return true
	}
...
// SetApplicationMesh gets a reference to the given map[string]interface{} and assigns it to the ApplicationMesh field.
func (o *V202101beta1TestSettings) SetApplicationMesh(v map[string]interface{}) {
	o.ApplicationMesh = &v
}
...
func (o V202101beta1TestSettings) MarshalJSON() ([]byte, error) {
	...
	if o.ApplicationMesh != nil {
		toSerialize["applicationMesh"] = o.ApplicationMesh
	}
	if o.AgentIds != nil {
