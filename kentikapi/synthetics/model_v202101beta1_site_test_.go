...
type NullableV202101beta1SiteTest struct {
	value *V202101beta1SiteTest
	isSet bool
}

func (v NullableV202101beta1SiteTest) Get() *V202101beta1SiteTest {
	return v.value
}

func (v *NullableV202101beta1SiteTest) Set(val *V202101beta1SiteTest) {
	v.value = val
	v.isSet = true
}

func (v NullableV202101beta1SiteTest) IsSet() bool {
	return v.isSet
}
...
func NewNullableV202101beta1SiteTest(val *V202101beta1SiteTest) *NullableV202101beta1SiteTest {
	return &NullableV202101beta1SiteTest{value: val, isSet: true}
}
