...
// GetCssSelectors returns the CssSelectors field value if set, zero value otherwise.
func (o *V202101beta1HTTPConfig) GetCssSelectors() map[string]string {
	if o == nil || o.CssSelectors == nil {
		var ret map[string]string
		return ret
	}
	return *o.CssSelectors
}

// GetCssSelectorsOk returns a tuple with the CssSelectors field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V202101beta1HTTPConfig) GetCssSelectorsOk() (*map[string]string, bool) {
	if o == nil || o.CssSelectors == nil {
		return nil, false
	}
	return o.CssSelectors, true
}

// HasCssSelectors returns a boolean if a field has been set.
func (o *V202101beta1HTTPConfig) HasCssSelectors() bool {
	if o != nil && o.CssSelectors != nil {
		return true
	}
...
// SetCssSelectors gets a reference to the given map[string]string and assigns it to the CssSelectors field.
func (o *V202101beta1HTTPConfig) SetCssSelectors(v map[string]string) {
	o.CssSelectors = &v
}
...
func (o V202101beta1HTTPConfig) MarshalJSON() ([]byte, error) {
	...
	if o.CssSelectors != nil {
		toSerialize["cssSelectors"] = o.CssSelectors
	}
