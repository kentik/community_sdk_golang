...
type NullableV202101beta1HostnameTest struct {
	value *V202101beta1HostnameTest
	isSet bool
}

func (v NullableV202101beta1HostnameTest) Get() *V202101beta1HostnameTest {
	return v.value
}

func (v *NullableV202101beta1HostnameTest) Set(val *V202101beta1HostnameTest) {
	v.value = val
	v.isSet = true
}

func (v NullableV202101beta1HostnameTest) IsSet() bool {
	return v.isSet
}

func (v *NullableV202101beta1HostnameTest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV202101beta1HostnameTest(val *V202101beta1HostnameTest) *NullableV202101beta1HostnameTest {
	return &NullableV202101beta1HostnameTest{value: val, isSet: true}
}
