...
type NullableV202101beta1IpTest struct {
	value *V202101beta1IpTest
	isSet bool
}

func (v NullableV202101beta1IpTest) Get() *V202101beta1IpTest {
	return v.value
}

func (v *NullableV202101beta1IpTest) Set(val *V202101beta1IpTest) {
	v.value = val
	v.isSet = true
}
...
func NewNullableV202101beta1IpTest(val *V202101beta1IpTest) *NullableV202101beta1IpTest {
	return &NullableV202101beta1IpTest{value: val, isSet: true}
}
